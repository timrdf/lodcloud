#!/bin/bash
#
#3> <> prov:specializationOf <https://github.com/timrdf/lodcloud/tree/master/data/source/datahub-io/dataset-entry-revisions/version/retrieve.sh>;
#3>    prov:wasDerivedFrom   <https://github.com/timrdf/lodcloud/tree/master/data/source/us/the-living-lod-cloud/version/retrieve.sh>;
#3>    prov:wasDerivedFrom   <https://github.com/timrdf/csv2rdf4lod-automation/blob/master/bin/cr-create-versioned-dataset-dir.sh>;
#3>    a conversion:Idempotent;
#3> .
#
