...
if [[ -n "$X_ALCHEMY_API_Key" ]]; then
   ...
   api='http://access.alchemyapi.com'
   curl -d '' "$api/calls/text/TextGetRankedNamedEntities?apikey=$X_ALCHEMY_API_Key&text=The%20City%20by%20the%20Bay%3b%20Fog%20City%3b%20San%20Fran%3b%20Frisco%3b%20The%20City%20that%20Knows%20How%20%3b%20Baghdad%20by%20the%20Bay%20%3b%20The%20Paris%20of%20the%20West&outputMode=rdf" > source/san-francisco-nicknames-entity-extraction.rdf
else
